...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCACCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCACCOUNT actions', async () => {
      const expectedActions = [
        {
